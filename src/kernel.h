// Copyright (c) 2012-2025 The EqualishCoin developers
...
// equalishcoin: block version supermajority calculation
...
// equalishcoin: entropy bit for stake modifier if chosen by modifier
