...
static RPCHelpMan loadwallet()
{
    return RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting equalishcoind will be"
...
static RPCHelpMan reservebalance()
{
    return RPCHelpMan{"reservebalance",
                "Set reserve amount not participating in network protection.\n",
                {
                    ...
                    {"amount", RPCArg::Type::NUM, RPCArg::Optional::OMITTED, "amount of equalishcoin to be reserved."},
                },
                RPCResult{RPCResult::Type::OBJ, "", "", {
                    {RPCResult::Type::BOOL, "reserve", "status of reserve."},
                    {RPCResult::Type::NUM, "amount", "amount of equalishcoin reserved."},
                }},
                RPCExamples{
