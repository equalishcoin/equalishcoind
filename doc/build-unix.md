UNIX BUILD NOTES
====================
Some notes on how to build EqualishCoin in Unix.

(For BSD specific instructions, see `build-*bsd.md` in this directory.)

Note
---------------------
Always use absolute paths to configure and compile EqualishCoin and the dependencies,
...
This will build equalishcoin-qt as well, if the dependencies are met.
...
memory available when compiling EqualishCoin. On systems with less, gcc can be
...
If you want to build EqualishCoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and an equalishcoin-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip equalishcoind" to strip the debug
...
Security
--------
To help make your equalishcoin installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, equalishcoin should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, equalishcoin may be compiled in
...
As mentioned above, when maintaining portability of the wallet between the standard EqualishCoin distributions and independently built
